"""
---
title: "CRI-CORE Publication Stage Enforcement Test (missing publication context)"
...
anchors:
  - "CRI-CORE-PUBLICATION-FAIL-TEST-v0.1.0"
---
"""
...
def test_publication_stage_fails_when_publication_section_is_missing():
    """
    Verifies that the publication stage fails when the publication section
